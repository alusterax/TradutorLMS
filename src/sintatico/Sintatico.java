...
public class Sintatico {
	...
	public void Erro(int j){
		switch(j){
		case 1:
			Tela.Erro_Sin.add("Defina um identificador - "+(i+1)+"º token");
			break;
		case 2:
			Tela.Erro_Sin.add("Literal não especificado - "+(i+1)+"º token");
			break;
		case 3:
			Tela.Erro_Sin.add("Inteiro não especificado - "+(i+1)+"º token");
			break;
		case 4:
			Tela.Erro_Sin.add("Codigo incompleto - "+(i+1)+"º token");
			break;
		case 5:
			Tela.Erro_Sin.add("Inicie o codigo com \"program\" - "+(i+1)+"º token");
			break;
		case 6:
			Tela.Erro_Sin.add("Complete a instrução com \";\" (ponto e vírgula) - "+(i+1)+"º token");
			break;
		case 7:
			Tela.Erro_Sin.add("Finalize o código com \".\" (ponto ) - "+(i+1)+"º token");
			break;
		case 8:
			Tela.Erro_Sin.add("Expecifique um comando - "+(i+1)+"º token");
			break;
		case 9:
			Tela.Erro_Sin.add("Complete a instrução com \":\" (dois pontos) - "+(i+1)+"º token");
			break;
		case 10:
			Tela.Erro_Sin.add("Inicie o corpo com \"begin\" - "+(i+2)+"º token");
			break;
		case 11:
			Tela.Erro_Sin.add("Finalize o corpo com \"end\" - "+(i+1)+"º token");
			break;
		case 12:
			Tela.Erro_Sin.add("Defina a costante - "+(i+1)+"º token");
			break;
		case 13:
			Tela.Erro_Sin.add("Defina uma procedure - "+(i+1)+"º token");
			break;
		case 14:
			Tela.Erro_Sin.add("Defina um label - "+(i+1)+"º token");
			break;
		case 15:
			Tela.Erro_Sin.add("Defina a(s) variável(is) - "+(i+1)+"º token");
			break;
		case 16:
			Tela.Erro_Sin.add("Defina o inicio da expressão - "+(i+1)+"º token");
			break;
		case 17:
			Tela.Erro_Sin.add("Você deve definir uma variável, um inteiro ou uma expressão - "+(i+1)+"º token");
			break;
		case 18:
			Tela.Erro_Sin.add("Defina a atribuição - "+(i+1)+"º token");
			break;
		case 19:
			Tela.Erro_Sin.add("Defina os parametros - "+(i+1)+"º token");
			break;
		case 20:
			Tela.Erro_Sin.add("Não escreva código depois do \"end.\"");
			break;
		case 21:
			Tela.Erro_Sin.add("Termine a primeira linha com \";\" (ponto e virgula) - "+(i+1)+"º token");
			break;
		case 22:
			Tela.Erro_Sin.add("Comando \"for\" incompleto - "+(i+1)+"º token");
			break;
		case 23:
			Tela.Erro_Sin.add("Comando \"call\" incompleto - "+(i+1)+"º token");
			break;
		case 24:
			Tela.Erro_Sin.add("Comando \"goto\" incompleto - "+(i+1)+"º token");
			break;
		case 25:
			Tela.Erro_Sin.add("Comando \"if\" incompleto - "+(i+1)+"º token");
			break;
		case 26:
			Tela.Erro_Sin.add("Comando \"while\" incompleto - "+(i+1)+"º token");
			break;
		case 27:
			Tela.Erro_Sin.add("Comando \"repeat\" incompleto - "+(i+1)+"º token");
			break;
		case 28:
			Tela.Erro_Sin.add("Comando \"readln\" incompleto - "+(i+1)+"º token");
			break;
		case 29:
			Tela.Erro_Sin.add("Comando \"writeln\" incompleto - "+(i+1)+"º token");
			break;
		case 30:
			Tela.Erro_Sin.add("Comando \"case\" incompleto - "+(i+1)+"º token");
			break;
		case 31:
			Tela.Erro_Sin.add("Separe comandos com \";\" (ponto e vigula) - "+(i+1)+"º token");
			break;
		case 32:
			Tela.Erro_Sin.add("Termine o comando \"array\" - "+(i+1)+"º token");
			break;
		case 33:
			Tela.Erro_Sin.add("Passagem de parametros incompleta ou errada - "+(i+1)+"º token");
			break;
		default:
			Tela.Erro_Sin.add("Erro! - "+(i+1)+"º token\n");
			break;
		}
	}
}